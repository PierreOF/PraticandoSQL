...
/* O NUMERO DE DEPARTAMENTO DE ROUPAS É MAIOR QUE O DE FILMES (21 / 53) */
SELECT nome FROM funcionarios WHERE departamento = 'roupas' OR departamento = 'filmes';
/* QUANTIDADE LAR > FILMES */
SELECT nome FROM funcionarios WHERE (departamento = 'lar' OR departamento = 'filmes') AND sexo = 'Feminino';
